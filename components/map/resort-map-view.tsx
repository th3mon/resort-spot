...
export function ResortMapView() {
  return (
    <section className="resort-map-view flex min-h-0 flex-1 flex-col gap-5">
      <header className="resort-map-view__header flex flex-col gap-3 border-b border-[#d5dfd6] bg-[#f8faf6] px-5 py-4 sm:px-8">
        <div className="resort-map-view__heading-group">
          <p className="resort-map-view__eyebrow text-xs font-semibold uppercase text-[#54705d]">
            Resort Spot
          </p>
      ...
      <main className="resort-map-view__content flex min-h-0 flex-1 flex-col gap-5 px-5 pb-6 sm:px-8 lg:flex-row">
        <ResortMapClient />
        <MapLegend />
      </main>
    </section>
