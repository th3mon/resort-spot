...
export function MapGrid({
  ...
  return (
    <div className="map-grid ui-enter overflow-x-auto justify-items-center rounded border border-(--color-border-muted) bg-(--color-surface-map) p-4 shadow-md shadow-(color:--color-shadow-soft)">
      <div
